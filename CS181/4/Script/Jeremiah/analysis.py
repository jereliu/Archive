...
sett_dir = "data/0.001-3/"
sett_dir2 = "data/25 x 25/e 0.01 mean 83, state 1410/"
...
state_num2 = \
    np.load(data_dir + sett_dir2 + "state_num_manual.npy")
...
x_center = \
    np.append(np.append([-100], np.array(range(-100, 400, 25)) + 12.5), [350])
p_center = \
...
ggsave(scatter2, "./plot/s_scatter_grid.png")

# velocity state travelled
v_hist = ggplot(state_num_pd, aes(x = "v")) + \
          geom_bar() + \
          geom_vline(xintercept = range(-40, 41, 20),
                     colour="darkred") + \
          ggtitle("Velocity State Traveled")

ggsave(v_hist, "./plot/v_hist0.png")
...
ggsave(v_hist_d, "./plot/v_death_hist0.png")
...
v_hist = ggplot(state_num_pd, aes(x = "v")) + \
          geom_bar() + \
          geom_vline(xintercept = v_grid,
                     colour="darkred") + \
          ggtitle("Velocity State Traveled")

ggsave(v_hist, "./plot/v_hist_grid.png")


'''
# 2.1. Generate plot with running mean
'''
file_dir3 = "data/score/"
rm11 = np.load(data_dir + file_dir3 + "1-1.npy")
rm12 = np.load(data_dir + file_dir3 + "1-2.npy")
rm13 = np.load(data_dir + file_dir3 + "1-3.npy")
rm23 = np.load(data_dir + file_dir3 + "2-3.npy")

rm31 = np.load(data_dir + file_dir3 + "3-1.npy")
rm33 = np.load(data_dir + file_dir3 + "3-3.npy")

np.savetxt("rm11.txt", rm11)
np.savetxt("rm12.txt", rm12)
np.savetxt("rm13.txt", rm13)
np.savetxt("rm23.txt", rm23)
np.savetxt("rm31.txt", rm31)
np.savetxt("rm33.txt", rm33)
